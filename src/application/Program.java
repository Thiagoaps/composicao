...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		int mounth = Integer.parseInt(monthAndYear.substring(0, 2)); // aqui se pega apenas os dois primeiro caracteres na posição 0 e 1, mas sempre tem que colocar uma a mais
